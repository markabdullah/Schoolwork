...
def test_create_stations_simple():
    ...
    assert station.num_bikes == 18                      # coordinates!
...
def test_get_position_ride():
    ...
    assert (
        ride.get_position(datetime(2017, 6, 1, 7, 54, 0)) ==
        approx((-73.54628920555115, 45.57713595014113),
               abs=1e-5)
    )
    assert (
        ride2.get_position(datetime(2017, 6, 1, 8, 30, 0)) ==
        approx((-73.57477158, 45.5081439),
               abs=1e-5)
    )
    assert (
        ride3.get_position(datetime(2017, 6, 1, 8, 15, 0)) ==
        approx((-73.561273, 45.515299),
               abs=1e-5)
    )
    assert (
        ride2.get_position(datetime(2017, 6, 1, 8, 34, 0)) ==
        approx((-73.57254266738892, 45.504407470403315),
               abs=1e-5)
    )
