...
class LinkedList:
    ...
    def __setitem__(self, index: int, item: object) -> None:
        ...
        curr = self._first
        currindex = 0
        while currindex != index and curr.next is not None:
            curr = curr.next
            currindex += 1
        if currindex == index:
            curr.item = item
    ...
    def extend(self, items: list) -> None:
        ...
        '[1 -> 2 -> 3 -> 4 -> 5 -> 6 -> 7]'
        """
        lst2 = LinkedList(items)
        curr = self._first
        while curr.next is not None:
            curr = curr.next
        curr.next = lst2._first
    ...
    def invert(self):
        ...
        while curr is not None:
            ...
            if output._first is not None:
                new_node.next = output._first
            output._first = new_node
            curr = curr.next
        return output
